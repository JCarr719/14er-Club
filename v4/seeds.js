...
var data = [
    {
        ...
        description: 'Tallest 14er in Colorado, 13.1 mile trail to the top'
    },{
        name: 'Mount Cameron',
        image: 'http://88keys.net/garyblog/wp-content/uploads/garyblog/2008/08/p1010646.JPG',
        description: 'A beautiful hike, located near three other easiliy accesible peaks.'
    },{
        name: 'Maroon Bells',
        image: 'https://fastestknowntime.com/sites/default/files/styles/very_large/public/2018-01/MaroonBells.JPG?itok=MGpCGmM0',
        description: 'Some of the most iconic peaks in the state, and often considered the most beautiful.'
    }
    ];
